 ...
 */
public class Agents_Form_Update extends AppCompatActivity implements AsyncTaskListener, SpecialCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agents_form_update);
        ...
        actionBar.setTitle("Client Form (Draft)");
        Bundle extras = getIntent().getExtras();
        am = (Albums_model) extras.getSerializable("form");
//        new Toaster(getApplicationContext(),am.getForm_id());
        init_cdv();
    }
    ...
    public void init_cdv() {
        ...
        am = dh.forms.getFormByHashKey(am.getForm_id());
...
//        new Toaster(getApplicationContext(),""+pm.size());
        ...
        rl_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Agents_Form_Update.this, Agents_Retake_Pictures.class);
                if (pm.size() == 0) {
...
//                    new Toaster(getApplicationContext(), "" + vps.getCurrentItem());
        ...
        rl_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Agents_Form_Update.this,Agents_Add_Pictures.class);
...
//                am.setDate_created(tv_date.getText().toString());
        ...
        rl_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int gz=0;gz<pm.size();gz++) {
                    ...
                    new ImageUniversalUploader(getApplicationContext(), Agents_Form_Update.this, pm.get(gz).getFile_path(), api, pd, "uploading",additional).uploadImage();
    ...
    public void onTaskComplete(String result) {
        ...
        try {
            ...
            if (success) {
                 if(service.equalsIgnoreCase("create_form")){
            ...
            if(success){
                ...
                if(service.equalsIgnoreCase("upload_form_image")){
                    ...
                    if(pictureCounter==pm.size()){
                        ...
                        String toPass="";
                        try {
                            toPass = URLEncoder.encode(tv_client_name.getText().toString(), "UTF-8") + "/" + "" + am.getForm_id() + "/" + "description" + "/" + am.getForm_id() + "/" + "" + pm.size() + "/" + new SharedPrefManager(getApplicationContext()).agentGet().get_id() + "/";
                        }catch (Exception e){
