...
public class Agents_Form_View_Reports extends AppCompatActivity implements AsyncTaskListener, SpecialCallBack {

    //CameraView cv;
    DatabaseHandler dh;
    TextView form_id, tv_agent_name, tv_date, tv_client_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agents_form_view_reports);
        ...
        actionBar.setTitle("Client Form");
...
//                Intent i = new Intent(Agents_Form_View_Reports.this, Agents_Retake_Pictures.class);
//                if (pm.size() == 0) {
//                    new Toaster(getApplicationContext(), "There's no image to update!");
//                } else {
//                    i.putExtra("picture_info", pm.get(vps.getCurrentItem()));
//                    i.putExtra("forms_hashkey", am.getForms_hashkey());
...
//            @Override
//            public void onClick(View v) {
//                Intent i = new Intent(Agents_Form_View_Reports.this,Agents_Add_Pictures.class);
//
//                if(pm.size()==0) {
...
//
//                    new ImageUniversalUploader(getApplicationContext(), Agents_Form_View_Reports.this, pm.get(gz).getFile_path(), api, pd, "uploading",additional).uploadImage();
//
//
//                }
//
            ...
            if(success){
                ...
                if(service.equalsIgnoreCase("upload_form_image")){
                    ...
                    if(pictureCounter==pm.size()){
                        ...
                        new API_TEST(Agents_Form_View_Reports.this, Agents_Form_View_Reports.this, false).execute("POST", "apij/update_form/1/" + am.get_id()+"/"+pm.size());
                    }
                }
            }else{
