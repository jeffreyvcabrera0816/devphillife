 ...
 */
public class API_TEST extends AsyncTask<String, Void, String> {
    ...
    public API_TEST(Context activity, AsyncTaskListener cb, Boolean refresh_count) {
    ...
    String fetchAPI() {
        ...
        try {
            URL url = new URL(Settings.base_url_test + api_url);
