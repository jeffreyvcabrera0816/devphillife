 ...
 */
public class Fragment_Announcements extends Fragment implements AsyncTaskListener  {
    ...
    public static Fragment_Announcements newInstance(Context c){

        Fragment_Announcements fa = new Fragment_Announcements();
    ...
    void init_fragment_announcements(){
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                new API(getActivity(), Fragment_Announcements.this, true).execute("POST", "api/announcements/");
            }
        });
        new API(getActivity(), Fragment_Announcements.this, false).execute("POST", "api/announcements/");
