...
import com.tidalsolutions.phillife.CommunityDetails;
...
public class ForumAdapter extends android.widget.BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = li.inflate(R.layout.community_row, parent, false);
        ...
        if (!threadImage[position].equals("")) {
            ...
            aq.id(holder.img).image(imgaq, false, false);
        } else {
        ...
        holder.row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, CommunityDetails.class);
